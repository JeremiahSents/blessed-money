...
import { UsersIcon, WalletIcon, ActivityIcon, FileTextIcon, Loader2Icon } from "lucide-react";
                        ...
                        <div className="flex flex-col gap-3">
                            <Link href="/customers" className="w-full">
                                <Button variant="outline" className="w-full justify-start text-left">
                                    <UsersIcon className="w-4 h-4 mr-3 text-zinc-500" />
                                    Manage Customers
                                </Button>
                            </Link>
                            <Link href="/payments" className="w-full">
                                <Button variant="outline" className="w-full justify-start text-left">
                                    <WalletIcon className="w-4 h-4 mr-3 text-zinc-500" />
                                    All Payments
                                </Button>
                            </Link>
                        </div>
