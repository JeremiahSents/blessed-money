...
function SidebarRail({ className, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden h-auto w-4 rounded-none border-0 bg-transparent p-0 transition-all ease-linear hover:bg-transparent group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] hover:after:bg-sidebar-border sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
